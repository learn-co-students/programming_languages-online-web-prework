    ...
    language_hash.each do |language, attribute_hash|
      ...
      attribute_hash.each do |attribute, str_value|
        ...
        if language_attributes[language].nil?
          ...
          #initiate a new hash for the value of :ruby
        end
        language_attributes[language][:style] ||= []
        # create a :style key within that hash and set it equal to an empty array
        language_attributes[language][:style] << oo_or_functional
        #added oo key from first level of languages hash to this key
        if language_attributes[language][attribute].nil?
          ...
          #set this :type key to equal the str "interpreted"
        end
      end
    end
  end
